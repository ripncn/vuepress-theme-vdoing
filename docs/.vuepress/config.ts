...
const DOMAIN_NAME = 'doc.lovou.pw' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'ripncn/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'RipnCN', // 必需
      link: 'https://github.com/ripncn', // 可选的
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'Ov23lix4wvF2vOmlfRrm',
          clientSecret: 'ffefca10fdfcb4f9606d15e2fac7d2188d559a46',
          repo: 'vuepress-theme-vdoing', // GitHub 仓库
          owner: 'ripncn', // GitHub仓库所有者
          admin: ['ripncn'], // 对仓库有写权限的人
